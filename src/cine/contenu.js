...
export const FR = {
  ...
  site: {
    ...
    problemeIntro: 'Ce soir, un potentiel client cherche vos services dans votre région. Si votre entreprise n’est pas visible, celle d’un concurrent apparaîtra à votre place.',
    problemePoints: [
